...
@Component("LibriScolasticiTrackingOrdiniRestService")
public class LibriScolasticiTrackingOrdiniRestService extends BaseRestService<TrackingDto, RicercaLibriTestoDto> implements RestService<TrackingDto, RicercaLibriTestoDto> {
	...
	@Autowired
	LibriScolasticiTrackingOrdiniRestService(@Value("${igeriv.scolastica.txt.rest.url}") String txtRestUrl, @Value("${igeriv.scolastica.txt.env.deploy.name}") String env) {
