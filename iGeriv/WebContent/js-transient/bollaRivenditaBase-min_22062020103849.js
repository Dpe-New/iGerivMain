		        ...
		        for (var j = 0, cell; cell = row.cells[j]; j ++) {
		            ...
		            switch (index) {
		                  ...
		                  case 12: {
		                	  ...
		                	  var hasIdMessaggioIdtn = (typeof($idMessaggioIdtn) != 'undefined') && $idMessaggioIdtn != '' && $fb != 'true';
...
//			                			  str += '&nbsp;<img name="noteRiv" id="noteRiv' + $idtn + '" src="/app_img/' + imgName + '" border="0px" style="border-style: none" onclick="javascript: addNote(\'' + titoloSottotitolo + '\',\'' + $idtn + '\',\'' + cpu + '\')" title="' + titleMsg + '" alt="' + msgNoteRivendita + '" />';
//			                		  }else{
//			                			  str += '&nbsp;<img name="noteRiv" id="noteRiv' + $idtn + '" src="/app_img/note_rivendita_32x32_disabled.png" border="0px" style="border-style: none" />';
//
//			                		  }
			                	  }
	...
	function disableBollaConsegna() {
		disableAllFormFields('dlSelect','dataTipoBolla','soloRigheSpuntare','submitFilter','barcode','popup_ok','imgPubb');			
