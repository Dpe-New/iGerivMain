...
<s:form id="EditPwdEdicolaForm" action="edicole_savePwdEdicola.action"
	namespace="/dl" method="POST" theme="igeriv" validate="false"
	...
	<div id="mainDiv" style="width: 100%">
		<fieldset class="filterBolla" style="text-align: left; width: 100%">
			...
			<div class="tableFields" style="float: left; width: 400px">
				<div style="float: left; left: 200px">
					<s:text name="dpe.login.dl.fieg.code.short" />
				</div>
				<div style="float: left; left: 200px; color: black">
					<s:text name="edicola.codEdicolaDl" />
				</div>
			</div>
			<div class="tableFields" style="float: left; width: 400px">
				<div style="float: left; left: 200px">
					<s:text name="dpe.login.dl.web.code.short" />
				</div>
				<div style="float: left; left: 200px; color: black">
					<s:text name="edicola.codEdicolaWeb" />
				</div>
			</div>
			<div class="tableFields" style="float: left; width: 400px">
				<div style="float: left; left: 200px">
				...
				<div style="float: left; left: 200px; color: black">
					<s:text name="edicola.ragioneSociale1" />
				</div>
			</div>
			<div class="tableFields" style="float: left; width: 400px">
				<div style="float: left; left: 200px">
				...
				<div style="float: left; left: 200px; color: black">
					<s:textfield label="" name="edicola.password" id="password"
						cssStyle="width: 200px" cssClass="tableFields" />
				</div>
			</div>
			<div class="tableFields" style="float: left; width: 400px">
				<div style="float: left; left: 200px">
					<s:text name="dpe.invia.email.conferma.credenziali" />
				</div>
				<div style="float: left; left: 200px">
		...
		<div
			style="text-align: center; margin-left: auto; margin-right: auto; width: 400px; margin-top: 20px">
