...
<s:if test="%{#request.listPubblicazioni != null && !#request.listPubblicazioni.isEmpty()}">
	...
	<s:form id="InfoPubblicazioniForm" action="infoPubblicazioni_showNumeriPubblicazioni.action" method="POST" theme="simple" validate="false" onsubmit="return (ray.ajax())">	
		<div style="width:850px">					
			<dpe:table
				tableId="InfoPubblicazioniTab" 
				...
				<ec:row style="height:20px" interceptor="marker">				
					...
					<ec:column property="barcode" width="14%" title="igeriv.barcode" cell="textBarcodeAlt" filterable="false" sortable="false"/>
					
					<dpe:column property="barcode_new" title="igeriv.barcode.new" validateIsNumeric="true" maxlength="18" size="25" width="14%"  cell="barcodenew" sessionVarName="nuovoBarcodeMap" 
								filterable="false" sortable="false" style="text-align:left" exportStyle="text-align:center" pkName="pk" enabledConditionFields="enabled" enabledConditionValues="true"/>
					 
					<ec:column property="immagine" title="igeriv.img" filterable="false" viewsDenied="pdf,xls" sortable="false" width="8%" style="text-align:center">
		...
		<div style="width:450px; margin-top:0px; margin-left:330px;">
			...
			<input type="button" value="<s:text name='igeriv.memorizza'/>" name="igeriv.memorizza" id="memorizzaBarcodeNew" class="tableFields" style="width:100px; text-align:center"/></div>
		</div>
