...
public interface IGerivBatchBo extends Serializable {
	...
	/**
	 * Cancella dal file system le immagini dell pubblicazioni pi� vecchie di x giorni
	 */
	 ...
	 * dove x � il parametro <code>IGerivConstants.COD_PARAMETRO_EDICOLA_GIORNI_STORICO_BOLLE_PRODOTTI_VARI</code> 
	 ...
	 * 
	 */
	public void updateEsportazioneResaSuccessTesta(List<Long> listIdDocumento);
	
	/**
	 * 
	 */
	public void updateEsportazioneResaErrorTesta(List<Long> listIdDocumento);
