...
public class EncryptUtils {
	...
	public static Cipher getEncrypter(String token) throws NoSuchAlgorithmException, UnsupportedEncodingException, NoSuchPaddingException, InvalidKeyException {
		Cipher result = null;

		MessageDigest digester = MessageDigest.getInstance(MESSAGE_DIGEST_ALGORITHM);
		digester.update(token.getBytes("UTF8"));
	...
	public static Cipher getDecrypter(String token) throws NoSuchAlgorithmException, UnsupportedEncodingException, NoSuchPaddingException, InvalidKeyException {
		Cipher result = null;
	...
	public static String decrypt(Cipher cipher, String data) throws UnsupportedEncodingException, IllegalBlockSizeException, BadPaddingException {
		...
		byte[] dataAsBA = Base64.decodeBase64(data.getBytes());
