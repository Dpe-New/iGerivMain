 ...
 * @author romanom
 */
@Component("InforivEstrattoContoReseImporter")
public class InforivEstrattoContoReseImporterImpl extends InforivEstrattoContoBaseImporterImpl implements InforivImporter<InforivEstrattoContoDto> {
	private final IGerivBatchService bo;
	
	@Autowired
	InforivEstrattoContoReseImporterImpl(IGerivBatchService bo) {
		this.bo = bo;
	}
