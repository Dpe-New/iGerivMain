...
<script>
	...
	$('#MessaggiTab_table tbody tr').each(function() {				
		...
		if (typeof($(this).attr('an')) !== 'undefined' && $(this).attr('an') != '') {				
			str += '<a href="${pageContext.request.contextPath}${ap}/attachment.action?fileName=' + $(this).attr('an') + '" target="new"><img src="/app_img/attachment_small.png" border="0px" width="30px" height="30px" style="border-style: none" title="<s:text name="igeriv.allegato"/>" alt="<s:text name="igeriv.allegato"/>" /></a>';	
		}   
		str += '</span>';			
		child1.html(str);	
		...
		if (typeof($(this).attr('an1')) !== 'undefined' && $(this).attr('an1') != '') {				
			str += '<a href="${pageContext.request.contextPath}${ap}/attachment.action?fileName=' + $(this).attr('an1') + '" target="new"><img src="/app_img/attachment_small.png" border="0px" width="30px" height="30px" style="border-style: none" title="<s:text name="igeriv.allegato"/>" alt="<s:text name="igeriv.allegato"/>" /></a>';	
		}   
		str += '</span>';			
		child2.html(str);
		...
		if (typeof($(this).attr('an2')) !== 'undefined' && $(this).attr('an2') != '') {				
			str += '<a href="${pageContext.request.contextPath}${ap}/attachment.action?fileName=' + $(this).attr('an2') + '" target="new"><img src="/app_img/attachment_small.png" border="0px" width="30px" height="30px" style="border-style: none" title="<s:text name="igeriv.allegato"/>" alt="<s:text name="igeriv.allegato"/>" /></a>';	
		}   
		str += '</span>';			
		child3.html(str);				
	});	
