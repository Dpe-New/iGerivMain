...
<style>
		div#filter { height:150px; }
</style>
<s:form id="filterForm" action="messages_showMessagesEdicole.action" method="POST" theme="simple" onsubmit="return (ray.ajax())" validate="false">	
	<div style="width:100%; text-align:center">
		<fieldset class="filterBolla" style="width:620px; height:120px;"><legend style="font-size:100%"><s:property value="filterTitle" /></legend>
			<div>
