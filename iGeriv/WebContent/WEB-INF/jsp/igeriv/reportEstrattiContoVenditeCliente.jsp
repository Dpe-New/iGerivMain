...
<s:form id="EstrattoContoClientiForm"
	action="estrattoContoVenditeClientiEdicola_showEstrattoContoClienti.action"
	...
	<div style="width: 100%; text-align: center">
		<fieldset class="filterBolla" style="height: 100px">
			...
			<div class="required">
				<div
					style="margin-left: auto; margin-right: auto; text-align: center; width: 240px; white-space: nowrap;">
			...
			<div class="required">
				<div
					...
					<s:select name="strDataA" id="strDataA" list="listEstrattiConto"
						cssStyle="width:130px" emptyOption="true"
	...
	<div id="mainDiv" style="width: 100%">
		<dpe:table tableId="EstrattoContoClientiTab"
			...
			<ec:exportXls fileName="estrattoContoCliente_${nomeCliente}.xls"
				tooltip="plg.esporta.excel" />
			<dpe:row interceptor="marker" style="height:25px">
				<dpe:column property="tipoMovimento" width="20%"
					title="igeriv.tipo.movimento" filterable="false" sortable="false" />
				<dpe:column property="dataMovimento" width="20%"
					title="igeriv.data.movimento" cell="date"
					dateFormat="dd/MM/yyyy HH:mi:ss" filterable="false"
	...
	<div style="text-align: center; margin-top: 15px;">
		<s:text name="igeriv.importo.debito" />
		:&nbsp;&nbsp;<span id="impDebito"
