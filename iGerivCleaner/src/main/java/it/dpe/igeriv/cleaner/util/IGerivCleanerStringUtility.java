 ...
 */
public class IGerivCleanerStringUtility {
	...
	public static String getBrowserName(String header) {
		if (!Strings.isNullOrEmpty(header)) {
			if (header.toUpperCase().contains(IGerivCleanerConstants.BROWSER_NAME_IE)) {
				return IGerivCleanerConstants.BROWSER_NAME_IE;
			} else if (header.toUpperCase().contains(IGerivCleanerConstants.BROWSER_NAME_FIREFOX)) {
				return IGerivCleanerConstants.BROWSER_NAME_FIREFOX;
			} else if (header.toUpperCase().contains(IGerivCleanerConstants.BROWSER_NAME_CHROME)) {
				return IGerivCleanerConstants.BROWSER_NAME_CHROME;
			} else if (header.toUpperCase().contains(IGerivCleanerConstants.BROWSER_NAME_SAFARI)) {
				return IGerivCleanerConstants.BROWSER_NAME_SAFARI;
			} else if (header.toUpperCase().contains(IGerivCleanerConstants.BROWSER_NAME_OPERA)) {
				return IGerivCleanerConstants.BROWSER_NAME_OPERA;
			}
		}
		return "";
	}
