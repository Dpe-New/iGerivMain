...
/**
 * Interfaccia rifornimenti
 * 
 * @author mromano
 *
 */
public interface RifornimentiService extends BaseService {
	...
	/**
	 * @param buildListRichiestaRifornimentoVo
	 * @param listRichiestaRifornimentoVoAggiunte
	 * @param listDeleteRichiestaRifornimentoVo
	 * @param prenotazioneVo
	 */
	 ...
	 * @param codUtente
	 * @param dataCompEC
	 * @param saveEvasionePrenotazioneVendite
	 * @param mapEvasione
	 * @return
	 * @throws ParseException
	 */
