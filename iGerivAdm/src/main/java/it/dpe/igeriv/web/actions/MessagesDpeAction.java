...
public class MessagesDpeAction<T extends BaseVo> extends
	...
	public List<MessaggioDpeDto> getMessaggi() {
		return messaggi;
	}

	public void setMessaggi(List<MessaggioDpeDto> messaggi) {
		this.messaggi = messaggi;
	}

	public MessaggioDpeDto getMessaggio() {
		return messaggio;
	}

	public void setMessaggio(MessaggioDpeDto messaggio) {
