...
<div style="width:100%">		 
		<dpe:table
			...
			<dpe:row highlightRow="true" interceptor="marker" style="height:30px; cursor:pointer" href="#?pk=pk">					
				...
				<ec:column property="attachmentName1" width="5%" title="igeriv.allegato1" filterable="false" sortable="false" viewsDenied="pdf,xls"/>  				
			</dpe:row>
		</dpe:table>
</div>		
</s:form>
