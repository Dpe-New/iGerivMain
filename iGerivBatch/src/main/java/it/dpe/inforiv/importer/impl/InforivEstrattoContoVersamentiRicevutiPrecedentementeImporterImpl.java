 ...
 * @author romanom
 */
@Component("InforivEstrattoContoVersamentiRicevutiPrecedentementeImporter")
public class InforivEstrattoContoVersamentiRicevutiPrecedentementeImporterImpl extends InforivEstrattoContoBaseImporterImpl implements InforivImporter<InforivEstrattoContoDto> {
	private final IGerivBatchService bo;
	
	@Autowired
	InforivEstrattoContoVersamentiRicevutiPrecedentementeImporterImpl(IGerivBatchService bo) {
		this.bo = bo;
	}
