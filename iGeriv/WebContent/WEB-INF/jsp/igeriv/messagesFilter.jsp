...
<s:form id="filterForm" action="%{actionName}" method="POST"
	theme="simple" onsubmit="return (doSubmit() && ray.ajax())"
	validate="false">
	<div style="width: 100%; text-align: center">
		<fieldset class="filterBolla" style="width: 700px; height: 132px;">
			...
			<div class="required">
				...
				<div style="float: right; width: 100px;">
					<font color="red" size="1"><span id="err_autocomplete"><s:fielderror>
