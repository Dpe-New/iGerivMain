 ...
 * @author romanom
 */
@Component("InforivEstrattoContoAddebitiNonEditorialiImporter")
public class InforivEstrattoContoAddebitiNonEditorialiImporterImpl extends InforivEstrattoContoBaseImporterImpl implements InforivImporter<InforivEstrattoContoDto> {
	private final IGerivBatchService bo;
	
	@Autowired
	InforivEstrattoContoAddebitiNonEditorialiImporterImpl(IGerivBatchService bo) {
		this.bo = bo;
	}
