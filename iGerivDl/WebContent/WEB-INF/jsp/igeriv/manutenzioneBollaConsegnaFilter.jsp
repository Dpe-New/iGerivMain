...
<s:form id="filterForm" action="%{actionName}" method="POST" theme="simple" validate="false" onsubmit="return (doSubmit() && ray.ajax())">	
	<div style="width:100%; text-align:center">
		...
		<fieldset class="filterBolla" style="width:520px; height:230px;"><legend style="font-size:100%"><s:property value="filterTitle" /></legend>
			<div class="required" style="width:520px;"> 
				...
				<div style="float:left; width:300px;"><s:textfield id="autocomplete" name="autocomplete" cssStyle="width: 300px" cssClass="tableFields"/></div>
			</div>
			<div class="required" style="width:520px;  margin-top:60px;">
				<div style="float:left; width:200px;"><s:text name="igeriv.data.bolla" /></div>
				<div style="float:left; width:300px; text-align:left"><s:textfield name="strData" id="strData" cssStyle="width:78px;" disabled="false"/></div>	
			</div>
			<div class="required" style="width:520px;  margin-top:30px;">
				<div style="float:left; width:200px;"><s:text name="igeriv.tipo.bolla" /></div>
			...
			<div class="required" style="width:520px;  margin-top:30px;">
				<div style="float:left; width:200px;"><s:text name="igeriv.stato" /></div>
				<div style="float:left; width:300px; text-align:left">
					<s:select label=""
					    name="statoBolla"
					    id="statoBolla" 
