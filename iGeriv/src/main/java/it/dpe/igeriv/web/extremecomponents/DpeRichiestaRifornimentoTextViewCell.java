...
public class DpeRichiestaRifornimentoTextViewCell implements Cell {
	...
	public String getHtmlDisplay(TableModel model, Column column) {
		...
		try {
			...
			boolean hasLivellmentiAndFieldNotEditable = !bean.getLivellamentoEditable();
			boolean fieldNotEditable = !isTextFieldEnabled(bean, enabledConditionFieldsArr, enabledConditionValuesArr) && (permetteInserimentoRichiesteRifornimentoFuture == null || !permetteInserimentoRichiesteRifornimentoFuture);
