...
<s:form id="PubblicazioniForm" action="%{actionName}" namespace="%{#context['struts.actionMapping'].namespace}" onsubmit="return (ray.ajax())" method="POST" theme="simple" validate="false">	
