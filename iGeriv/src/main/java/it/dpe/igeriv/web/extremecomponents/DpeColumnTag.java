...
public class DpeColumnTag extends ColumnTag {
	...
	private String fieldEnabled;
	private String modalitaInforiv;
	...
	public String getFieldEnabled() {
		return fieldEnabled;
	}

	public void setFieldEnabled(String fieldEnabled) {
		this.fieldEnabled = fieldEnabled;
	}
	
	public String getModalitaInforiv() {
		return modalitaInforiv;
	}

	public void setModalitaInforiv(String modalitaInforiv) {
		this.modalitaInforiv = modalitaInforiv;
	}
	...
	public void addColumnAttributes(TableModel model, Column column) {
		...
		column.addAttribute("fieldEnabled", fieldEnabled);
		column.addAttribute("modalitaInforiv", modalitaInforiv);
