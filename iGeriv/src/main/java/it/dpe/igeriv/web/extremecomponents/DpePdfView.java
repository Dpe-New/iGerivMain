...
public class DpePdfView extends PdfView {
	public final static String GLOBAL_FONT = "exportPdf.font";
	public final static String GLOBAL_TOTALS_FONT_SIZE = "exportPdf.totalsFontSize";
	public final static String GLOBAL_FONT_SIZE = "exportPdf.fontSize";
	public final static String GLOBAL_HEAD_FONT_SIZE = "exportPdf.headFontSize";
	...
	public final static String TOTALS_FONT_SIZE = "totalsFontSize";
	public final static String HEAD_FONT_SIZE = "headFontSize";
	...
	public void beforeBody(TableModel model) {
		...
		this.font = model.getPreferences().getPreference(GLOBAL_FONT);
		this.fontSize = model.getPreferences().getPreference(GLOBAL_FONT_SIZE);
		this.totalsFontSize = model.getPreferences().getPreference(GLOBAL_TOTALS_FONT_SIZE);
		this.headFontSize = Strings.isNullOrEmpty(export.getAttributeAsString("headFontSize")) ? model.getPreferences().getPreference(GLOBAL_HEAD_FONT_SIZE) : export.getAttributeAsString("headFontSize");
		
		font = !Strings.isNullOrEmpty(export.getAttributeAsString(FONT)) ? export.getAttributeAsString(FONT) : this.font;
		fontSize = !Strings.isNullOrEmpty(export.getAttributeAsString(FONT_SIZE)) ? export.getAttributeAsString(FONT_SIZE) : this.fontSize;
		totalsFontSize = !Strings.isNullOrEmpty(export.getAttributeAsString(TOTALS_FONT_SIZE)) ? export.getAttributeAsString(TOTALS_FONT_SIZE) : this.totalsFontSize;
		headFontSize = !Strings.isNullOrEmpty(export.getAttributeAsString(HEAD_FONT_SIZE)) ? export.getAttributeAsString(HEAD_FONT_SIZE) : this.headFontSize;
		...
		ParametriEdicolaDto param = model.getContext().getSessionAttribute("paramEdicola5") != null ? (ParametriEdicolaDto) model.getContext().getSessionAttribute("paramEdicola5") : null;
			...
			for (int i = 0; i < rows; i++) {
				...
				for (Iterator<Column> iter = model.getColumnHandler().getColumns().iterator(); iter.hasNext();) {
					...
					if (column.isCalculated()) {
						...
						if (value != null) {
							String formatNumber = NumberUtils.formatNumber(value, model.getLocale(), column.getFormat());
