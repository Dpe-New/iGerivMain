...
<s:if test="%{#request.bolleRiassunto != null && !#request.bolleRiassunto.isEmpty()}">
	...
	<s:form id="ManutenzioneBollaResaForm" action="edicole_showEdicole.action" method="POST" theme="simple" validate="false" onsubmit="return (ray.ajax())">
	<div style="width:100%">
	<s:if test="(strData != null && strData != '') && (codEdicola == null || codEdicola == '')">
		<dpe:table
				tableId="ManutenzioneBollaResaTab"
				...
				form="ManutenzioneBollaResaForm"
				...
				>
				<dpe:exportPdf         
					fileName="mantenzione_bolla_resa.pdf"         
				...
				/>
				<ec:exportXls     
					fileName="mantenzione_bolla_resa.xls"      
				...
				<ec:row style="height:20px">		
					...
					<ec:column property="descFerie" width="5%" title="igeriv.stato.ferie" filterable="false" style="text-align:center"/>
				</ec:row>
			</dpe:table>
	</s:if>
	<s:else>		
