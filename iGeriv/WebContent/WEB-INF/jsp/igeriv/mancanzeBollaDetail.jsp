...
<div id="contentDiv" style="margin-top: 30px">
	<dpe:table tableId="MancanzeBollaDettaglioTab"
		items="mancanzeDettaglio" var="mancanzeDettaglio"
		...
		style="height:60px; width:350px" view="buttonsOnBottom"
		locale="${localeString}"
