	...
	<s:form id="LibriScolasticiTrackingForm" action="%{actionName}"	method="POST" theme="simple" validate="false"	onsubmit="return (ray.ajax())">
		<div style="width: 100%">
			<dpe:table 
				...
				locale="${localeString}"
				state="it.dpe.igeriv.web.actions.LibriScolasticiTrackingAction"
				...
				<dpe:row style="height:30px; cursor:pointer">
					...
					<ec:column property="descrizioneStato" width="15%"				title="dpe.dettaglio.libro.descrizioneStato" filterable="false" />
					...
					<ec:column property="urlImmagineCopertina" title="igeriv.img" filterable="false"		sortable="false" width="4%" style="text-align:center"	viewsDenied="pdf,xls">
						<a href="${pageScope.elencoLibriTraking.urlImmagineCopertina}" rel="thumbnail"><img	src="/app_img/camera-active.png" width="15px" height="15px" border="0"  style="border-style: none" /></a>
					</ec:column>
