		...
		<div style="width:850px">					
			<dpe:table
				...
				<ec:row style="height:20px" interceptor="marker">				
					...
					<ec:column property="sottoTitolo" width="25%" title="igeriv.sottotitolo" filterable="false" sortable="false"/>
					...
					<ec:column property="tipoRichiamoResa" width="25%" title="igeriv.tipo.richiamo.resa" filterable="false"/>
					<ec:column property="note" width="10%" title="igeriv.fondo.bolla" filterable="false" style="text-align:center"/>
