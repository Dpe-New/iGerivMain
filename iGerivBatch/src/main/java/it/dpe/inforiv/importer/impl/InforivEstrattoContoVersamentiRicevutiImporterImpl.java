 ...
 * @author romanom
 */
@Component("InforivEstrattoContoVersamentiRicevutiImporter")
public class InforivEstrattoContoVersamentiRicevutiImporterImpl extends InforivEstrattoContoBaseImporterImpl implements InforivImporter<InforivEstrattoContoDto> {
	private final IGerivBatchService bo;
	
	@Autowired
	InforivEstrattoContoVersamentiRicevutiImporterImpl(IGerivBatchService bo) {
		this.bo = bo;
	}
