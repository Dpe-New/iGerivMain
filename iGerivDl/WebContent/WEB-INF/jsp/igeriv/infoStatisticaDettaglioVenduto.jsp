...
<div id="contentDiv" style="margin-top:30px">
	...
	<s:form id="StatisticaDettaglioForm" action="statisticaPubblicazioni_showStatisticaDettaglioVenduto.action" method="POST" theme="simple" validate="false" onsubmit="return (ray.ajax())">		
		<dpe:table
			...
			>
			<dpe:exportPdf         
				fileName="dettaglio_venduto_statistica.pdf"         
			...
			/> 
			<ec:exportXls     
				fileName="dettaglio_venduto_statistica.xls"      
				tooltip="plg.esporta.excel"/>		
			<ec:row style="height:25px">
				<dpe:column property="data" width="38%" title="igeriv.data.vendita" cell="date" format="dd/MM/yyyy HH:mm:ss" filterable="false" sortable="false" style="text-align:center" headerStyle="text-align:center"/>				
				<dpe:column property="copie" width="38%" title="igeriv.copie" filterable="false" sortable="false" style="text-align:center" headerStyle="text-align:center"/> 
			</ec:row>
		</dpe:table>	 	
	</s:form>
	</div>
