...
<s:form id="ProdottiForm" action="viewRichiesteProdotti_showViewRichiesteProdotti.action" namespace="%{#context['struts.actionMapping'].namespace}" onsubmit="return (ray.ajax())" method="POST" theme="simple" validate="false">	
		...
		<fieldset class="filterBolla" style="margin-top:0px; top:0px; width:800px; text-align:center"><legend style="font-size:100%"><s:text name="tableTitle"/></legend>
			<div class="required">
				...
				<div style="float:left; width:300px; text-align:left">
					<s:text name="igeriv.da" />&nbsp;&nbsp;<s:textfield name="strDataDa" id="strDataDa" cssClass="required" cssStyle="width:80px;" disabled="false"/>						
					&nbsp;&nbsp;
					<s:text name="igeriv.a" />&nbsp;&nbsp;<s:textfield name="strDataA" id="strDataA" cssClass="required" cssStyle="width:80px;" disabled="false"/>						
				</div>
			</div>
			<div class="required" style="align:center; text-align:center; width:550px">
				<div style="float:left; width:200px;">&nbsp;</div>
				<div style="float:left; width:100px;"><s:text name="igeriv.prodotto" /></div>
				<div style="float:left; width:200px;"><s:textfield label="" name="descrizione" id="descrizione" cssClass="required" cssStyle="width:230px;"/></div>				
			</div>			
			<div class="required" style="align:center; text-align:center; width:550px">
				<div style="float:left; width:200px;">&nbsp;</div>
				...
				<div style="float:left; width:200px;">
					<s:select label=""
					    ...
					    listKey="key" 
					    listValue="value"
					    list="%{#session['statiProdottoNonEditoriali']}"
					    emptyOption="true" 
