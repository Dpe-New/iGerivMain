...
<s:if
	...
	<s:form id="RichiesteRifornimentiClienteEdicolaForm"
		action="%{actionName1}" method="POST" theme="simple" validate="false"
		...
		<div id="mainDiv" style="width: 100%">
			<dpe:table tableId="RichiesteRifornimentiClienteEdicola"
				...
				imagePath="/app_img/table/*.gif" style="height:${tableHeight}"
				...
				<dpe:row highlightRow="true" style="height:30px">
					<dpe:column property="fake" width="3%" title=" "
						cell="prenotazioniClienteSpunta" pkName="pk"
					...
					<ec:column property="quantitaRichiesta" width="6%"
					...
					<ec:column property="quantitaEvasa" width="5%"
						...
						styleClass="extremeTableFields" style="text-align:center"
						headerStyle="text-align:center" filterable="false" />
					<ec:column property="statoEvasioneDesc" width="9%"
						title="igeriv.richiesta.rifornimenti.quantita.stato"
						styleClass="extremeTableFields" style="text-align:center"
						headerStyle="text-align:center" filterable="false" />
					<ec:column property="dataUltimaRisposta" width="8%"
						title="igeriv.data.ultima.evasione" cell="date"
						format="dd/MM/yyyy" styleClass="extremeTableFields"
		...
		<div style="width: 100%;">
			<div
				style="width: 350px; height: 50px; margin-top: 10px; margin-right: auto; margin-left: auto">
				<input type="button"
					value="<s:text name='igeriv.cancella.prenotazioni.selezionate'/>"
					name="aaaa" id="cancellaSelezione" class="tableFields"
					style="width: 260px; text-align: center"
					onclick="javascript: deleteSelected()" />
			</div>
		</div>
	</s:form>
	<div id="one"></div>
