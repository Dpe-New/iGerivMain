...
<s:form id="ProdottiForm" action="%{actionName}"
	...
	<div id="pubMainDiv" style="width: 100%;">
		<div style="width: 100%; text-align: left">
			...
			<fieldset class="filterBolla"
				style="margin-top: 0px; top: 0px; width: 870px; text-align: left">
				...
				<div class="required" style="align: left; text-align: center">
					<div style="float: left; width: 120px;">
						<s:text name="igeriv.codice" />
					</div>
					<div style="float: left; width: 240px;">
						<s:textfield label="" name="codice" id="codice"
							cssClass="required" cssStyle="width:240px;" />
					</div>
					<div style="float: left; width: 120px;">
				...
				<div class="required" style="align: left; text-align: center">
					...
					<div style="float: left; width: 240px;">
						<select name="categoria" id="categoria" class="required"
							style="width: 240px;">
							<option value=""></option>
							<s:iterator value="%{#session['listCategorie']}" status="status"
								var="arg">
								<option value="<s:property value='pk.codCategoria'/>"
									<s:if test="pk.codCategoria.toString() eq categoria">selected</s:if>><s:property
										value='descrizione' /></option>
							</s:iterator>
						</select>
					</div>
					<div style="float: left; width: 120px;">
					...
					<div style="float: left; width: 240px;">
						<select name="sottocategoria" id="sottocategoria" class="required"
							style="width: 240px;">
						</select>
					</div>
				</div>
				<div class="required" style="align: left; text-align: center">
					...
					<div style="float: left; width: 240px;">
						<s:textfield label="" name="barcode" id="barcode"
							cssClass="required" cssStyle="width:240px;" />
					</div>
				</div>
				<div class="required" style="align: left; text-align: center;">
					<div
						style="float: left; width: 850px; align: center; text-align: center; height: 50px; margin-top: 10px">
						<s:submit name="ricerca" id="ricerca"
							key="dpe.contact.form.ricerca" align="center" cssClass="required"
							cssStyle="text-align:center; width:150px" onclick="submitForm();" />
					</div>
				</div>
			</fieldset>
		</div>
