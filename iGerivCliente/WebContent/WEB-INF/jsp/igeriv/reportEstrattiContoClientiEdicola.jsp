...
<s:form id="EstrattoContoClientiForm" action="estrattoContoClientiEdicola_showClientiReportEstrattoConto.action" method="POST" theme="simple" validate="false">		
	<div id="mainDiv" style="width:100%">						
		<dpe:table
			...
			>
			<dpe:exportPdf         
				fileName="report_estratti_conto_clienti.pdf"         
			...
			/>
			<ec:exportXls     
				fileName="report_estratti_conto_clienti.xls"      
				tooltip="plg.esporta.excel"/>		
			<dpe:row highlightRow="true" interceptor="marker" href="#?idCliente=codCliente" style="cursor:pointer;height:30px;">
				<ec:column property="nome" width="12%" title="dpe.nome" filterable="false"/>         
