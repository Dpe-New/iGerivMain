...
<s:if
	...
	<div id="mainDiv" style="width: 100%; text-align: center">
		<s:form id="LivellamentiForm"
			action="avvisoLivellamenti_saveLivellamenti.action" method="POST"
			theme="simple" validate="false" onsubmit="return (ray.ajax())">
			<div class="eXtremeTable title"
				style="text-align: center; font-weight: bold;">
				<s:text name="igeriv.accetta.richieste.livellamenti.title" />
			</div>
			<div style="text-align: left;">
				<dpe:table tableId="LivellamentiTab" items="listLivellamenti"
					var="listLivellamenti"
					action="${pageContext.request.contextPath}/avvisoLivellamenti_saveLivellamenti.action"
					...
					<dpe:row highlightRow="true" interceptor="marker"
						...
						<dpe:column property="richiesta.storicoCopertineVo.sottoTitolo"
							width="10%" title="igeriv.sottotitolo" />
						<dpe:column
						...
						<dpe:column
							...
							width="33%" title="dpe.indirizzo" />
						<dpe:column property="fake" alias="spunta" width="5%"
							title="igeriv.accetta" cell="livellamentiSpunta"
			...
			<div style="width: 100%;">
				<div
					...
					<input type="button" value="<s:text name='igeriv.memorizza'/>"
						...
						onclick="javascript: setTimeout(function() {return (setFormAction('LivellamentiForm','avvisoLivellamenti_saveLivellamenti.action', '', '', false, '', function() {$('#close').trigger('click')}, '', false, '', false));},10);" />
				</div>
			</div>
		</s:form>
	</div>
