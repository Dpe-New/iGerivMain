...
<s:form id="filterForm" action="pneBollaCarico_showBolle.action"
	...
	<div style="width: 100%; text-align: center">
		<fieldset class="filterBolla"
			style="text-align: left; height: 180px; width: 300px;">
			...
			<div class="required">
				...
				<div style="float: left; width: 100px;">
					<s:select name="codiceCausale" id="codiceCausale"
						...
						list="%{#application['listCausali']}" cssStyle="width:100px" />
				</div>
			</div>
			<div class="required">
				<div
