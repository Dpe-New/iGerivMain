...
<s:form id="MancanzeFilterForm" action="mancanze_showMancanze.action" onsubmit="return (ray.ajax())" method="POST" theme="simple" validate="false">
	<div style="width:100%; text-align:center;">	
		...
		<fieldset class="filterBolla" style="width:450px; text-align:center"><legend style="font-size:100%"><s:text name="filterTitle"/></legend>
			<div class="required" style="margin-left:auto; margin-right:auto; align:center; text-align:center; width:450px">
				<div style="float:left; width:80px;"><s:text name="igeriv.data.uscita" /></div>
			...
			<div class="required" style="margin-left:auto; margin-right:auto; align:center; text-align:center; width:450px">
				...
				<div style="float:left; width:300px;"><s:textfield label="" name="titolo" id="titolo" cssClass="required" cssStyle="width:196px;"/></div>				
			</div>			
			<div class="required" style="margin-left:auto; margin-right:auto; align:center; text-align:center; width:450px">
				...
				<div style="float:left; width:300px;">
					<s:select label=""
					    ...
					    listKey="key" 
					    listValue="value"
					    list="%{#session['statiMancanzePubblicazioni']}"
					    emptyOption="true" 
