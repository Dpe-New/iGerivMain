 ...
 *
 */
public interface BolleService extends BaseService {
	 ...
	 * @param bollaRiassunto
	 */
	public void saveAndSendSpuntaBollaRivendita(String differenze, String spunte, String pk, String differenzeFondoBolla, String spunteFondoBolla, String pkFondoBolla, Integer codEdicola, LinkedHashMap<String, BollaRiassuntoVo> listBolleDistinct);
	 ...
	 * @param tipoBolla
	 * @param cpu
	 * @param numMaxCpuResaDimenticata
	 * @param tipoResaNoRifornimentoDimenticato
	 * @param giornoSettimanaPermesso
	 * @return
	 */
	 ...
	 * @param periodicita
	 * @param tipoBolla
	 * @param hasBolleQuotidianiPeriodiciDivise
	 * @param codFiegDl
	 * @param cpu
	 * @return
	 */
