...
<s:form id="filterForm"
	action="statisticaUtilizzo_showStatisticaUtilizzo.action" method="POST"
	theme="simple"
	onsubmit="return (validateFieldsStatisticaUtilizzo(true) && doSubmit() && ray.ajax())"
	validate="false">
	...
	<div style="width: 100%; text-align: center; margin-top: 10px;">
		<fieldset class="filterBolla" style="width: 700px; height: 200px;">
