 ...
 *
 */
@Component("immaginiMiniatureQuotidianiImporter")
public class ImmaginiMiniatureQuotidianiImporter {
	@Autowired
	...
	public synchronized void importaImmagini(File file) throws IOException, JAXBException {
		if (file.exists() && file.isFile() && file.canWrite()) {
			...
			try {
				...
				iGerivImportBo.importImmagineMiniaturaQuotidiano(file, titolo);
			} catch (Exception e) {
