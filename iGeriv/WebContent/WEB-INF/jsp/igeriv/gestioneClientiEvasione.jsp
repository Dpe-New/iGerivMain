	...
	<div style="width: 100%">
		<dpe:table 
			...
			<dpe:row highlightRow="true" interceptor="marker" href="#?idCliente=codCliente" style="height:30px; cursor:pointer">
				<dpe:column property="fake" width="3%" title=" " cell="selectedSpunta" headerCell="buttonSpuntaAutomaticaOrdiniClienti"	pkName="codCliente" hasHiddenPkField="true"	style="text-align:center" filterable="false" sortable="false"/>
				<ec:column property="nome" width="15%" title="dpe.nome"	filterable="false"/>
				<ec:column property="cognome" width="12%" title="dpe.cognome" filterable="false"/>
				<ec:column property="localitaDesc" width="12%" title="dpe.localita"	filterable="false"/>
				<ec:column property="provinciaDesc" width="8%" title="dpe.provincia" filterable="false"/>
				<ec:column property="cap" width="5%" title="dpe.cap" filterable="false"/>
				<ec:column property="telefono" width="8%" title="dpe.telefono" filterable="false"/>
				<ec:column property="email" width="15%" title="dpe.email" filterable="false"/>
				<ec:column property="qtaOrdiniDaEvadere" width="10%" title="igeriv.richiesta.rifornimenti.quantita.da.evadere" filterable="false" style="text-align:center"/>
				<ec:column property="tipoEstrattoContoDesc" width="10%"	title="igeriv.tipo.estratto.conto" filterable="false"/>
			</dpe:row>
		</dpe:table>
	</div>
	<div style="width: 100%; margin-top: 10px; text-align: center">
		<input type="button" name="evadi" id="evadi" value="<s:text name='igeriv.evadi.clienti.selezionati'/>" align="center" class="tableFields" style="text-align: center; width: 250px" onclick="javascript: evadiClientiSelezionati();" />
	</div>
</s:form>
