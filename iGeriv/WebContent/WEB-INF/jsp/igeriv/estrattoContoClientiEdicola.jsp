...
<s:if test="%{#request.clienti != null && !#request.clienti.isEmpty()}">
	<s:set name="keys" value="#application.listCSVNumber0to100" />
	<s:set name="values" value="#application.listCSVNumber0to100" />
	<s:form id="EstrattoContoClientiForm"
		action="estrattoContoClientiEdicola_showClientiEstrattoConto.action"
		method="POST" theme="simple" validate="false">
		<div id="mainDiv" style="width: 100%">
			<dpe:table tableId="EstrattoContoClientiTab" items="clienti"
				var="clienti"
				...
				<dpe:row highlightRow="true" interceptor="marker"
					...
					<dpe:column property="fake" width="4%" title=" "
						cell="selectedSpunta"
						headerCell="buttonSpuntaAutomaticaOrdiniClienti"
						pkName="codCliente" hasHiddenPkField="true"
						style="text-align:center" filterable="false" sortable="false" />
					<ec:column property="nome" width="13%" title="dpe.nome"
						filterable="false" />
					<ec:column property="cognome" width="13%" title="dpe.cognome"
						filterable="false" />
					<ec:column property="localitaDesc" width="13%" title="dpe.localita"
						filterable="false" />
					<ec:column property="provinciaDesc" width="5%"
					...
					<ec:column property="cap" width="5%" title="dpe.cap"
						filterable="false" headerStyle="text-align:center"
					...
					<ec:column property="email" width="15%" title="dpe.email"
						filterable="false" headerStyle="text-align:center"
						style="text-align:center" />
					<dpe:column property="totaleEstrattoContoPubb" cell="currency"
						width="7%" title="igeriv.importo.pubb" format="###,###,##0.00"
						hasCurrencySign="true" filterable="false"
						headerStyle="text-align:right" style="text-align:right" />
					<dpe:column property="totaleEstrattoContoPne" cell="currency"
						width="7%" title="igeriv.importo.prod" format="###,###,##0.00"
						hasCurrencySign="true" filterable="false"
						headerStyle="text-align:right" style="text-align:right" />
					<dpe:column property="sconto" cell="dpeECScontoCombo" width="7%"
						title="igeriv.sconto.perc.pub" filterable="false"
						hasEmptyOption="false"
						style="font-size:12px; width:80px; text-align:center"
						styleClass="extremeTableFieldsLarger" viewsDenied="pdf,xls"
						sortable="false" />
					<dpe:column property="scontoPne" cell="dpeECScontoComboPne"
						width="7%" title="igeriv.sconto.perc.prod" filterable="false"
						hasEmptyOption="false"
						style="font-size:12px; width:80px; text-align:center"
						styleClass="extremeTableFieldsLarger" viewsDenied="pdf,xls"
						sortable="false" />
			...
			<div style="text-align: center; margin-top: 15px;">
				...
				:&nbsp;&nbsp;
				<s:textfield name="strDataDocumento" id="strDataDocumento"
					cssStyle="width:90px;" disabled="false" />
				&nbsp;&nbsp;&nbsp;&nbsp;
				<s:text name="igeriv.sconto" />
				&nbsp;
				<s:text name="igeriv.pubblicazioni" />
				&nbsp;(
				<s:text name="igeriv.default" />
				):&nbsp;&nbsp;
				<s:select label="" name="scontoPerc" id="scontoPerc"
					listKey="keyInt" listValue="value"
					list="%{#application['listNumberVo0to100']}" emptyOption="false"
					cssStyle="width: 60px" />
				%&nbsp;&nbsp;&nbsp;&nbsp;
				<s:text name="igeriv.sconto" />
				&nbsp;
				<s:text name="igeriv.prodotti.vari" />
				&nbsp;(
				<s:text name="igeriv.default" />
				):&nbsp;&nbsp;
				<s:select label="" name="scontoPercPne" id="scontoPercPne"
					listKey="keyInt" listValue="value"
					list="%{#application['listNumberVo0to100']}" emptyOption="false"
					cssStyle="width: 60px" />
				%&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<div style="text-align: center; margin-top: 15px;">
				...
				:&nbsp;&nbsp;
				<s:textfield name="numeroFattura" id="numeroFattura"
					cssStyle="width:90px;" disabled="false"
					value="%{#session.mapParamsEdicola.paramEdicola17.paramValue}" />
			</div>
			<div style="text-align: center; margin-top: 15px;">
				<input type="button" value="" name="emettiEC" id="emettiEC"
					class="tableFields" style="width: 200px; text-align: center;"
					onclick="javascript: return emettiEstrattoConto();" />
			</div>
		</div>
