...
<ul id="listMenu">	
	...
	<li id="menuHomeLink">
		<a href="${pageContext.request.contextPath}${ap}/home.action" id="home" childs="">Home</a>
	</li>
		...
		<li>
			<s:iterator value="#list1" var="list2" status="s1">	
				...
				<s:iterator value="#list2" var="list3" status="s2">	
					...
					<s:if test="#s1.index > 0 && #list3.url != null && #list3.url != ''">
						<s:if test="#list3.attivo eq true"> 
							<a href="${pageContext.request.contextPath}${ap}/<s:text name='#list3.url'/>" id="<s:text name='#list3.url'/>" childs="<s:text name='#list3.actionName'/>">
						</s:if>  
						<s:else> 
					...
					<s:else> 
						<span style="color:#999;cursor:pointer" <s:if test="#session['hasProfiloStarter'] eq true && ((#sizeP > 0) && (#s1.index > 0)) || ((#size > 1) && (#s2.index > 0))">onclick="showMsgDisabledMenuStarterAlert();"</s:if>><s:text name="#list3.titolo18N"/></span>
					</s:else>	
					<s:if test="((#sizeP > 0) && (#s1.index eq 0)) || ((#size > 1) && (#s2.index eq 0))">
						</a></span>
					</s:if>					
					<s:if test="(#s1.index > 0 || #s2.index > 0) && #list3.url != null && #list3.url != ''">						
						</a>						
					</s:if>		
					<s:if test="((#sizeP > 0) && (#s1.index eq 0)) || ((#size > 1) && (#s2.index eq 0))">
