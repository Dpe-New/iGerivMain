...
<s:form id="RichiestaRifornimentoForm"
	action="sonoInoltreUscite_showVariazioni.action" method="POST"
	...
	<div style="width: 450px; margin-top: 50px; margin-left: 330px;">
		<div
			...
			<input type="button" value="<s:text name='igeriv.memorizza'/>"
				...
				style="width: 100px; text-align: center"
				onclick="javascript: setFormAction('RichiestaRifornimentoForm','sonoInoltreUscite_saveVariazioni.action', '', 'messageDiv');" />
		</div>
	</div>
</s:form>
<s:if
