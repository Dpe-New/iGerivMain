 ...
 * @author romanom
 */
@Component("InforivEstrattoContoFornitureImporter")
public class InforivEstrattoContoFornitureImporterImpl extends InforivEstrattoContoBaseImporterImpl implements InforivImporter<InforivEstrattoContoDto> {
	private final IGerivBatchService bo;
	
	@Autowired
	InforivEstrattoContoFornitureImporterImpl(IGerivBatchService bo) {
		this.bo = bo;
	}
