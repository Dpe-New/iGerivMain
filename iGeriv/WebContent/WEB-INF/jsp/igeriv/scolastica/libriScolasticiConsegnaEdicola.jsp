			...
			<dpe:table 
				...
				<dpe:row style="height:30px; cursor:pointer">
					...
					<ec:column property="urlImmagineCopertina" title="igeriv.img" filterable="false"		sortable="false" width="4%" style="text-align:center"	viewsDenied="pdf,xls">
						<a href="${pageScope.listResLibri.urlImmagineCopertina}" rel="thumbnail"><img	src="/app_img/camera-active.png" width="15px" height="15px" border="0"  style="border-style: none" /></a>
					</ec:column>
		...
		<div style="width: 100%">
			<dpe:table 
				...
				<dpe:row style="height:30px; cursor:pointer">
					...
					<ec:column property="urlImmagineCopertina" title="igeriv.img" filterable="false"		sortable="false" width="4%" style="text-align:center"	viewsDenied="pdf,xls">
						<a href="${pageScope.listResLibriRiepilogo.urlImmagineCopertina}" rel="thumbnail"><img	src="/app_img/camera-active.png" width="15px" height="15px" border="0"  style="border-style: none" /></a>
					</ec:column>
