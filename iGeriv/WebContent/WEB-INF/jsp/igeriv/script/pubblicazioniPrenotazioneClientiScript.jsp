...
<script>
	...
	$("table[id*='_table'] tbody").find("td:not(:last-child)").click(function() {
		    ...
		    var coddl = dim[2].split('=')[1];
		 	var url = "${pageContext.request.contextPath}/bollaRivendita_showPrenotazioniClienteEdicola.action?idtn=" + idtn + "&idCliente=" + document.getElementById('idCliente').value + "&cpu=" + cpu + "&coddl=" + coddl;
