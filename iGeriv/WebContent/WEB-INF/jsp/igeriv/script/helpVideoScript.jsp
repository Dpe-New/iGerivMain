...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/flowplayer-3.2.13.min.js"></script>
<script>
	$(document).ready(function() {		
		addFadeLayerEvents();
		// http://${pageContext.request.serverName}:${pageContext.request.serverPort}/video/flowplayer-3.2.8.swf
		$f("player", "http://${pageContext.request.serverName}:${pageContext.request.serverPort}/video/flowplayer-3.2.18.swf",  {
		//$f("player", "http://releases.flowplayer.org/swf/flowplayer-3.2.18.swf",  {
		    ...
		    plugins:  {
		        ...
		        time: {
		            ...
		            url: "http://${pageContext.request.serverName}:${pageContext.request.serverPort}/video/flowplayer.controls-3.2.16.swf",
		            top:0,
		            backgroundGradient: 'none',
