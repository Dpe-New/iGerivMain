...
public interface MailingListService {
	 ...
	 * @param label
	 * @param returnReceiptToAddress
	 * @param fromLabel
	 * @throws MessagingException
	 * @throws UnsupportedEncodingException
	 */
	public void sendEmailWithAttachments(String[] email, String subject, String message, File[] attachments, Boolean isHtml, String replyTo, boolean appendToConfiEmails, String label, String returnReceiptToAddress, String fromLabel) throws MessagingException, UnsupportedEncodingException;
