...
<div id="contentDiv" style="margin-top:30px">
	...
	<s:form id="StatisticaDettaglioForm" action="statisticaPubblicazioni_showStatisticaDettaglioReso.action" method="POST" theme="simple" validate="false" onsubmit="return (ray.ajax())">		
		<dpe:table
			tableId="StatisticaDettaglioTab" 
			items="listStatisticaDettaglio"
			var="listStatisticaDettaglio" 
			action="${pageContext.request.contextPath}/statisticaPubblicazioni_showStatisticaDettaglioReso.action"						
			...
			>
			<dpe:exportPdf         
				fileName="dettaglio_reso_statistica.pdf"         
			...
			/> 
			<ec:exportXls     
				fileName="dettaglio_reso_statistica.xls"      
				tooltip="plg.esporta.excel"/>		
			<ec:row style="height:25px">
				<dpe:column property="data" width="25%" title="igeriv.data.bolla" cell="date" dateFormat="dd/MM/yyyy" filterable="false" sortable="false" style="text-align:center" headerStyle="text-align:center"/>				
				...
				<dpe:column property="copie" width="25%" title="igeriv.copie" filterable="false" sortable="false" style="text-align:center" headerStyle="text-align:center"/> 
			</ec:row>
		</dpe:table>	 	
	</s:form>
	</div>
