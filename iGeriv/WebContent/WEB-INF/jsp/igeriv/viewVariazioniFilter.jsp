			...
			<div class="required"
				...
				<div style="float: left; width: 200px;">
					<s:select label="" name="stato" id="stato" listKey="key"
						listValue="value"
						list="%{#application['statiPrenotazioniPubblicazioniVariazioni']}"
						emptyOption="true" cssStyle="width: 230px" cssClass="required" />
				</div>
			</div>
			<div class="required" style="align: center; text-align: center;">
				<div
					style="float: left; width: 90%; align: center; text-align: center;">
