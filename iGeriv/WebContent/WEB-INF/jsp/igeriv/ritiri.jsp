...
<div id="contentDiv">
	<s:if test="%{#request.ritiri != null && !#request.ritiri.isEmpty()}">
		<s:form id="RitiriForm" action="ritiri_show.action" method="POST"
			theme="simple" validate="false" onsubmit="return (ray.ajax())">
			<div style="width: 100%">
				<dpe:table tableId="RitiriTab" items="ritiri" var="ritiri"
					action="ritiri_show.action" imagePath="/app_img/table/*.gif"
					style="table-layout:auto; height: 350px" view="buttonsOnBottom"
					locale="${localeString}"
					state="it.dpe.igeriv.web.actions.RitiriAction"
					styleClass="extremeTableFields" form="RitiriForm"
					...
					<dpe:exportPdf
						...
						tooltip="plg.esporta.pdf" headerTitle="${reportTitle}"
					...
					<dpe:row>
						<dpe:column property="fake" width="3%" title=" "
							cell="ritiriClienteSpunta" pkName="pk" hasHiddenPkField="true"
						...
						<ec:column property="tipoRitiro" width="10%"
							title="igeriv.tipo.ritiro" filterable="false"
							style="text-align:center" headerStyle="text-align:center" />
						...
						<ec:column property="numeroCopertina" width="10%"
							...
							style="text-align:center" headerStyle="text-align:center" />
						<dpe:column property="prezzoCopertinaVendita" width="10%"
							title="igeriv.prezzo.lordo" hasCurrencySign="true"
							format="###,###,##0.00" cell="currency" filterable="false"
							style="text-align:right" />
						<dpe:column property="quantita" width="8%" title="igeriv.quantita"
							filterable="false" style="text-align:center"
							headerStyle="text-align:center" />
						<dpe:column property="importoTotale" width="10%"
						...
						<dpe:column property="immagine" title="igeriv.img"
							...
							headerStyle="text-align:center"
							cell="viewImageCell" >
<%-- 							<a href="/${pageScope.ritiri.dirAlias}/${pageScope.ritiri.immagine}" --%>
...
<!-- 								height="15px" border="0" style="border-style: none" /></a> -->
			...
			<s:if test="authUser.tipoUtente == 1">
				<div style="text-align: center; margin-top: 15px;">
					<input type="button"
						value="<s:text name='igeriv.cancella.ritiri.selezionati'/>"
						name="butDeleteRitiri" id="butDeleteRitiri" class="tableFields"
						style="width: 200px; text-align: center;"
						onclick="javascript: return deleteRitiri();" />
				</div>
			</s:if>
		</s:form>
	</s:if>
