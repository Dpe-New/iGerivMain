...
<script>
	$(document).ready(function() {
	    ...
	    var url = "${pageContext.request.contextPath}/viewChart_getVendutoEstrattoContoChart.action?date=" + date + "&vendutoQuotidiani=" + vendutoQuotidiani + "&vendutoPeriodici=" + vendutoPeriodici + "&venduto=" + venduto;
