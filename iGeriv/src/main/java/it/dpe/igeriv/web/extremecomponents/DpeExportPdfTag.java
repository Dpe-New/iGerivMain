...
public class DpeExportPdfTag extends ExportPdfTag {
	...
	public void setTotalsFontSize(String totalsFontSize) {
		this.totalsFontSize = totalsFontSize;
	}
	...
	public void addExportAttributes(TableModel model, Export export) {
        ...
        export.addAttribute("font", font);
        export.addAttribute("fontSize", fontSize);
        export.addAttribute("totalsFontSize", totalsFontSize);
	}
