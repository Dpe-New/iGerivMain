 ...
 *
 */
public interface ClientiService<T> extends BaseService {
	 ...
	 * @return
	 */
	public List<ClienteEdicolaDto> getClientiEdicolaScolastica(Integer[] codEdicola, String nome, String cognome, Long codCliente,String numeroOrdineTxt);
