...
<s:form id="MancanzeFilterForm" action="mancanzeBolla_showMancanzeBolla.action" onsubmit="return (ray.ajax())" method="POST" theme="simple" validate="false">
	<div style="width:100%; text-align:center;">	
		...
		<fieldset class="filterBolla" style="width:450px; text-align:center"><legend style="font-size:100%"><s:text name="filterTitle"/></legend>
			<div class="required" style="margin-left:auto; margin-right:auto; align:center; text-align:center; width:450px">
				<div style="float:left; width:100px;"><s:text name="igeriv.data.bolla" /></div>
			...
			<div class="required" style="margin-left:auto; margin-right:auto; align:center; text-align:center; width:450px">
				<div style="float:left; width:120px;"><s:text name="igeriv.titolo" /></div>
				<div style="float:left; width:280px;"><s:textfield label="" name="titolo" id="titolo" cssClass="required" cssStyle="width:196px;"/></div>				
			</div>		
			<div class="required" style="float:left;">
				<div style="float:left; width:120px;"><s:text name="igeriv.mostra.solo.differenze" /></div> 
				<div style="float:left; width:280px"><s:checkbox name="soloDifferenze" id="soloDifferenze" cssClass="tableFields"/></div>
			</div>	
