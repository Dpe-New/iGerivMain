...
<div id="contentDiv">
	<s:if
		test="%{#request.listProdotti != null && !#request.listProdotti.isEmpty()}">
		<s:form id="ProdottiDetailForm" action="prodotti_showProdotti.action"
			method="POST" theme="simple" validate="false"
			onsubmit="return (ray.ajax())">
			<div style="width: 100%">
				<dpe:table tableId="ProdottiTab" items="listProdotti"
					var="listProdotti"
					...
					<dpe:exportPdf fileName="Prodotti.pdf" tooltip="plg.esporta.pdf"
						headerTitle="igeriv.prodotti.non.editoriali" headerColor="black"
						headerBackgroundColor="#b6c2da" isLandscape="true" />
					<ec:exportXls fileName="prodotti.xls" tooltip="plg.esporta.excel" />
					<dpe:row interceptor="marker" highlightRow="true"
						style="height:50px; cursor:pointer;"
						href="#?pk=codProdottoInterno">
						<dpe:column property="codiceProdottoFornitore" width="5%"
							title="igeriv.codice.prod.forn" filterable="false"
							style="text-align:center" headerStyle="text-align:center"
							exportStyle="text-align:center" />
						<dpe:column property="descrizione" width="25%"
							title="igeriv.prodotto" filterable="false"
							style="text-align:left" headerStyle="text-align:left" />
						<dpe:column property="categoria" width="18%"
							title="igeriv.categoria" filterable="false"
							style="text-align:center" headerStyle="text-align:center"
							exportStyle="text-align:center" />
						<dpe:column property="sottocategoria" width="16%"
							title="igeriv.sotto.categoria" filterable="false"
							style="text-align:center" headerStyle="text-align:center"
							exportStyle="text-align:center" />
						<dpe:column property="ultimoPrezzoAcquisto" width="8%"
							title="igeriv.imponibile" cell="currency" hasCurrencySign="true"
							filterable="false" style="text-align:right"
							headerStyle="text-align:right" exportStyle="text-align:right" />
						<dpe:column property="aliquota" width="8%"
							title="igeriv.aliquota.iva" filterable="false"
							style="text-align:right" headerStyle="text-align:right"
							exportStyle="text-align:right" />
						<dpe:column property="prezzoConAliquota" width="8%"
							title="igeriv.prezzo" cell="currency" hasCurrencySign="true"
							filterable="false" style="text-align:right"
							headerStyle="text-align:right" exportStyle="text-align:right" />
						<dpe:column property="giacenza" width="6%"
							title="igeriv.disponibilita" filterable="false" sortable="false"
							viewsDenied="pdf,xls" style="text-align:center"
							exportStyle="text-align:center" />
						<ec:column property="immagine" title="igeriv.img"
							...
							<a
								href="/immagini_prodotti_vari_dl/${pageScope.listProdotti.immagine}"
								rel="thumbnail"><img
								src="/immagini_prodotti_vari_dl/${pageScope.listProdotti.immagine}"
