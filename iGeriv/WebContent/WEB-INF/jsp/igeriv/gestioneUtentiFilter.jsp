		...
		<fieldset class="filterBolla" style="height: 140px; width: 400px;">
			...
			<div class="required">
				...
				<div style="float: left; width: 100px;">
					<s:textfield label="" name="codUtente" id="codUtente" />
				</div>
				<div style="float: right; width: 100px;">
					<font color="red" size="1"><span id="err_codUtente"><s:fielderror>
								<s:param>codUtente</s:param>
			...
			<div class="required">
				...
				<div style="float: left; width: 100px;">
					<s:textfield label="" name="nomeUtente" id="nomeUtente" />
				</div>
				<div style="float: right; width: 100px;">
					<font color="red" size="1"><span id="err_nomeUtente"><s:fielderror>
								<s:param>nomeUtente</s:param>
							</s:fielderror></span></font>
				</div>
			</div>
			<div class="required">
