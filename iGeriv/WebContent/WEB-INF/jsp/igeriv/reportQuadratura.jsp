...
<div id="contentDiv">
	<s:if
		test="%{#request.listQuadraturaResa != null && !#request.listQuadraturaResa.isEmpty()}">
		<s:set name="an" value="%{actionName}" />
		<s:set name="ap" value="#context['struts.actionMapping'].namespace" />
		<s:if test='#context["struts.actionMapping"].namespace == "/"'>
			<s:set name="ap" value="" />
		</s:if>
		<s:form id="QuadraturaResaForm" action="bollaResa_" method="POST"
			theme="simple" validate="false" onsubmit="return (ray.ajax())">
			<div style="width: 100%">
				<dpe:table tableId="BollaResaTab" items="listQuadraturaResa"
					...
					<dpe:exportPdf fileName="report_quadratura_resa.pdf"
						...
						marginTopInches="1.2" repeatColumnHeaders="true" />
					<ec:exportXls fileName="report_quadratura_resa.xls"
						tooltip="plg.esporta.excel" />
					<dpe:row style="height:25px">
						<ec:column property="cpu" width="5%"
							title="igeriv.codice.pubblicazione.title" filterable="false"
							style="text-align:center" headerStyle="text-align:center" />
						<ec:column property="titolo" width="19%" title="igeriv.titolo"
							filterable="false" />
						<ec:column property="numero" width="5%" title="igeriv.numero"
							filterable="false" style="text-align:center"
							headerStyle="text-align:center" />
						<ec:column property="copieDichiarate" width="8%"
							title="igeriv.copie.dichiarate" filterable="false"
							style="text-align:center" headerStyle="text-align:center" />
						<ec:column property="copieRiscontrate" width="8%"
							title="igeriv.copie.riscontrate" filterable="false"
							style="text-align:center" headerStyle="text-align:center" />
						<dpe:column property="differenza" width="8%"
							title="igeriv.differenza.ext" calc="total"
							calcTitle="column.calc.total" totalCellStyle="text-align:center"
							filterable="false" style="text-align:center"
							headerStyle="text-align:center" />
						<dpe:column property="valoreDichiarato" width="8%"
							title="igeriv.valore.dichiarato" cell="currency"
							format="###,###,##0.0000" hasCurrencySign="true"
							filterable="false" style="text-align:right"
							headerStyle="text-align:right" />
						<dpe:column property="valoreRiscontrato" width="8%"
							title="igeriv.valore.riscontrato" cell="currency"
							format="###,###,##0.0000" hasCurrencySign="true"
							filterable="false" style="text-align:right"
							headerStyle="text-align:right" />
						<dpe:column property="differenzaValore" width="8%"
							title="igeriv.differenza.ext" calc="total" cell="currency"
							format="###,###,##0.0000" hasCurrencySign="true"
							filterable="false" style="text-align:right"
							headerStyle="text-align:right" totalCellStyle="text-align:right" />
						<ec:column property="copieRespinte" width="8%"
							title="igeriv.copie.respinte" filterable="false"
							style="text-align:center" headerStyle="text-align:center" />
						<dpe:column property="motivo" width="15%" title="igeriv.motivo"
