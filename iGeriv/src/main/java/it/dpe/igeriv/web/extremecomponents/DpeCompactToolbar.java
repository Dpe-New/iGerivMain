...
public class DpeCompactToolbar extends CompactToolbar {
	...
	protected void columnCenter(HtmlBuilder html, TableModel model) {
        ...
        Object extraToolButton4 = model.getTableHandler().getTable().getAttribute("extraToolButton4");
        Object extraToolButton5 = model.getTableHandler().getTable().getAttribute("extraToolButton5");
        ...
        Object extraToolButton4Style = model.getTableHandler().getTable().getAttribute("extraToolButton4Style");
        Object extraToolButton5Style = model.getTableHandler().getTable().getAttribute("extraToolButton5Style");
        ...
        if (extraToolButton4 != null && !extraToolButton4.equals(DPEWebContants.BLANK)) {
        	HtmlBuilder td = html.td(1);
        	td.styleClass(BuilderConstants.STATUS_BAR_CSS);
        	if (extraToolButton4Style != null) {
        		td.style(extraToolButton4Style.toString());
        	}
        	td.close();
        	html.append(extraToolButton4);
        	html.tdEnd();
		}
        if (extraToolButton5 != null && !extraToolButton5.equals(DPEWebContants.BLANK)) {
        	HtmlBuilder td = html.td(1);
        	td.styleClass(BuilderConstants.STATUS_BAR_CSS);
        	if (extraToolButton5Style != null) {
        		td.style(extraToolButton5Style.toString());
        	}
        	td.close();
        	html.append(extraToolButton5);
        	html.tdEnd();
		}
	}
