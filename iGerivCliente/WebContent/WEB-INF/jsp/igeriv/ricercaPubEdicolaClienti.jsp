...
<s:set var="href" value="%{'#?idtn=idtn&coddl=coddl'}" />	
		...
		<div style="width:100%">					
			<dpe:table
				...
				<dpe:row highlightRow="true" interceptor="marker" style="height:30px; cursor:pointer" href="${href}">				
					<ec:column property="titolo" width="23%" title="igeriv.titolo" filterable="false"/>         
					<ec:column property="sottoTitolo" width="22%" title="igeriv.sottotitolo" filterable="false"/> 
					...
					<dpe:column property="dataUscita" width="10%" title="igeriv.data.uscita" cell="date" dateFormat="dd/MM/yyyy" filterable="false" style="text-align:center" headerStyle="text-align:center"/>
