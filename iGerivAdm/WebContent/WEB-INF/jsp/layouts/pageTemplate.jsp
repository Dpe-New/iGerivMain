...
<body onload="javascript: onLoadFunction();">
    <div id="page"> 
    	<div id="header">
    		...
    		<div id="logout"><tiles:insertAttribute name="logout" /></div>
    		<div id="dl"><tiles:insertAttribute name="dl" /></div>
    		<div id="icons"><tiles:insertAttribute name="icons" /></div>
    		<div id="user"><tiles:insertAttribute name="user" /></div>
    	</div>
    	<div id="menu">    		
    		<div><tiles:insertAttribute name="menu" /></div>
    	</div>
    	<div id="breadCrumb"><tiles:insertAttribute name="breadCrumb" /></div>
    	<div id="filter"><div id="help" style="position:absolute; cursor: pointer; margin-left:70px; margin-top:30px;"></div><tiles:insertAttribute name="filter" /></div>
        <div id="content1"><tiles:insertAttribute name="content1" /></div>
        <div id="content2"><tiles:insertAttribute name="content2" /></div>
        <div id="popup_name" class="popup_block ui-draggable"></div>
        <div id="footer"><tiles:insertAttribute name="footer" /></div>
        <div id="popup_name_det" class="popup_block ui-draggable"></div>
        
        <div id="popup_name_dettaglio_profilo" class="popup_block ui-draggable"></div>
...
<div><tiles:insertAttribute name="unblockUserScript" /></div>
<head>
	<!--[if IE ]>
	<META HTTP-EQUIV="Pragma" CONTENT="no-cache">
	<META HTTP-EQUIV="Expires" CONTENT="-1">
