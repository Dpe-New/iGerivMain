...
<s:form id="MancanzeFilterForm"
	action="mancanzeBolla_showMancanzeBolla.action"
	...
	<div style="width: 100%; text-align: center;">
		...
		<fieldset class="filterBolla" style="width: 450px; text-align: center">
			...
			<div class="required" style="float: left;">
				<div style="float: left; width: 120px;">
					<s:text name="igeriv.mostra.solo.differenze" />
				</div>
				<div style="float: left; width: 280px">
					<s:checkbox name="soloDifferenze" id="soloDifferenze"
