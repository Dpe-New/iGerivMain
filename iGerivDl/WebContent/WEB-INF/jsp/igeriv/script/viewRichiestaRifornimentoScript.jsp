...
<script>
	$(document).ready(function() {		
		$('#RichiestaRifornimentoTab_table tbody tr td:nth-child(10), #RichiestaRifornimentoTab_table tbody tr td:nth-child(11), #RichiestaRifornimentoTab_table tbody tr td:nth-child(12)').each(function() {
		...
		$('#RichiestaRifornimentoTab_table tbody tr').each(function() {
			...
			if ($tr.attr("rigaEvasione") == 'true') { 
				...
				$tr.find("td:nth-child(10)").text('<s:text name="igeriv.evaso"/>');
