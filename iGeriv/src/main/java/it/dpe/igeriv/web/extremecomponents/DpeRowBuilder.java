...
public class DpeRowBuilder extends RowBuilder {
	...
	public void rowStart() {
        ...
        if (!Strings.isNullOrEmpty(getRow().getAttributeAsString("idMessaggioIdtn"))) {
        	getHtmlBuilder().append(" idMessaggioIdtn='" + getRow().getAttributeAsString("idMessaggioIdtn") + "'");
        }
        if (!Strings.isNullOrEmpty(getRow().getAttributeAsString("agfc"))) {
        	getHtmlBuilder().append(" agfc='" + getRow().getAttributeAsString("agfc") + "'");
        }
        if (!Strings.isNullOrEmpty(getRow().getAttributeAsString("barf"))) {
        	getHtmlBuilder().append(" barf='" + getRow().getAttributeAsString("barf") + "'");
        }
        if (!Strings.isNullOrEmpty(getRow().getAttributeAsString("pnu"))) {
        	getHtmlBuilder().append(" pnu='" + getRow().getAttributeAsString("pnu") + "'");
        }
