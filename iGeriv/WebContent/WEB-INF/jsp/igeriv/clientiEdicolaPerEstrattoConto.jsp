	...
	<s:form id="GestioneClientiForm" action="%{actionName}" method="POST"
		...
		<div style="width: 100%">
			<dpe:table tableId="GestioneClientiTab" items="clienti" var="clienti"
				...
				form="GestioneClientiForm" theme="eXtremeTable bollaScrollDiv"
				showPagination="false" id="BollaScrollDiv1"
				...
				<dpe:row highlightRow="true" interceptor="marker"
					...
					<ec:column property="nome" width="22%" title="dpe.nome"
						filterable="false" />
					<ec:column property="cognome" width="22%" title="dpe.cognome"
						filterable="false" />
