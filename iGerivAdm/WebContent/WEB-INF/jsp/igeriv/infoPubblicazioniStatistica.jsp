...
<s:if test="%{#request.listPubblicazioni != null && !#request.listPubblicazioni.isEmpty()}">
	...
	<div id="mainDiv" style="width:100%">
		<s:form id="InfoPubblicazioniForm" action="statisticaPubblicazioni_showNumeriPubblicazioniStatistica.action" method="POST" theme="simple" validate="false" onsubmit="return (ray.ajax())">
			...
			<div style="width:850px">					
				<dpe:table
					...
					<dpe:row interceptor="marker" href="#?idtn=idtn" style="height:25px">				
						...
						<ec:column property="reso" width="5%" title="igeriv.reso.dichiarato" filterable="false" sortable="false" style="cursor:pointer; text-align:center"/>
						...
						<ec:column property="venduto" width="5%" title="igeriv.venduto" filterable="false" sortable="false" style="text-align:center"/>
						...
						<ec:column property="immagine" title="igeriv.img" filterable="false" viewsDenied="pdf,xls" sortable="false" width="8%">
