	...
	<s:form id="GestioneClientiForm" action="%{actionName}" method="POST"
		...
		<div style="width: 100%">
			<dpe:table tableId="GestioneClientiTab" items="clienti" var="clienti"
				...
				styleClass="extremeTableFields" style="height:370px;"
				...
				<dpe:row highlightRow="true" interceptor="marker"
					href="#?idCliente=codCliente" style="height:30px; cursor:pointer">
					...
					<ec:column property="cognome" width="12%" title="dpe.cognome"
						filterable="false" />
					<ec:column property="localitaDesc" width="12%" title="dpe.localita"
						filterable="false" />
					<ec:column property="provinciaDesc" width="8%"
					...
					<ec:column property="email" width="15%" title="dpe.email"
						filterable="false" />
					<ec:column property="qtaOrdiniDaEvadere" width="10%"
						title="igeriv.richiesta.rifornimenti.quantita.da.evadere"
						filterable="false" style="text-align:center" />
					<ec:column property="tipoEstrattoContoDesc" width="10%"
						title="igeriv.tipo.estratto.conto" filterable="false" />
				</dpe:row>
			</dpe:table>
		</div>
		<div style="width: 100%; margin-top: 10px; text-align: center">
			<input type="button" name="evadi" id="evadi"
				value="<s:text name='igeriv.evadi.clienti.selezionati'/>"
				align="center" class="tableFields"
				style="text-align: center; width: 250px"
				onclick="javascript: evadiClientiSelezionati();" />
		</div>
	</s:form>
