		...
		<fieldset class="filterBolla" style="text-align:left; width:700px"><legend style="font-size:100%"><s:property value="tableTitle" /></legend>
			<div style="width:650px;">	
				...
				<div id="giriDiv" class="required">
					...
					<div id="giriList" style="float:left; margin-left:30px; width:380px; height:100px; overflow-y:scroll; text-align:center">
				...
				<div id="zoneDiv" class="required">
					...
					<div id="zoneList" style="float:left; margin-left:30px; width:380px; height:100px; overflow-y:scroll; text-align:center">
						
					</div>
				</div>	
				<div class="required">
					<div style="float:left; width:200px; margin-top:20px; height:50px;"><s:text name="igeriv.tipo.messaggio" /></div>	
					<div style="float:left; width:420px;">
						<s:select label=""
				...
				<div style="width:640px;">
					...
					<s:else>
						<div class="required" style="height:30px">
							<div style="float:left; width:100px;"><s:text name="igeriv.allegato1" /></div>
							<div style="float:left; width:220px;"><a href="${pageContext.request.contextPath}${ap}/attachment.action?fileName=<s:text name="messaggio.attachmentName1" />" target="new" class="textLinks"><s:text name="messaggio.attachmentName1" /></a></div>
					...
					<s:else>
						<div class="required" style="height:30px">
							<div style="float:left; width:100px;"><s:text name="igeriv.allegato2" /></div>
							<div style="float:left; width:220px;"><a href="${pageContext.request.contextPath}${ap}/attachment.action?fileName=<s:text name="messaggio.attachmentName2" />" target="new" class="textLinks"><s:text name="messaggio.attachmentName2" /></a></div>
					...
					<s:if test="messaggio.attachmentName3 == null || messaggio.attachmentName3 == ''">
						<div class="required" style="height:30px">
							...
							<div style="float:left; width:220px;"><s:file name="attachment3" label="File2" /></div>	
