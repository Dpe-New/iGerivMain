 ...
 * @author romanom
 */
@Component("InforivEstrattoContoTotalePrecedenteImporter")
public class InforivEstrattoContoTotalePrecedenteImporterImpl extends InforivEstrattoContoBaseImporterImpl implements InforivImporter<InforivEstrattoContoDto> {
	private final IGerivBatchService bo;
	
	@Autowired
	InforivEstrattoContoTotalePrecedenteImporterImpl(IGerivBatchService bo) {
		this.bo = bo;
	}
