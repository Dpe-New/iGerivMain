...
<div id="contentDiv" style="margin-top: 30px">
	...
	<div id="mainDiv" style="width: 100%">
		<s:form id="StatisticaDettaglioForm"
			action="statisticaPubblicazioni_showStatisticaDettaglioReso.action"
