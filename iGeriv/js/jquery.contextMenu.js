...
if (jQuery) (function() {
    $.extend($.fn, {
        ...
        contextMenu: function(o, callback) {
            ...
            if (o.xLeft == undefined) o.xLeft = 180;
            if (o.yTop == undefined) o.yTop = 155;
            if(o.highlight == undefined) o.highlight = false;
                ...
                $(this).mousedown(function(e) {
                    ...
                    $(this).mouseup(function(e) {
                        ...
                        if (evt.button == 2 || o.leftButton == true) {
                            ...
                            $(menu).css({ top: y - o.yTop, left: x - o.xLeft }).fadeIn(o.inSpeed);
                            // Hover events
