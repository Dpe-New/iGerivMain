...
<s:if
	test="%{#request.listContoDeposito != null && !#request.listContoDeposito.isEmpty()}">
	<s:form id="ContoDepositoForm"
		action="infoPubblicazioni_reportContoDeposito.action" method="POST"
		theme="simple" validate="false" onsubmit="return (ray.ajax())">
		<div style="width: 100%">
			<dpe:table tableId="ContoDepositoTab" items="listContoDeposito"
				...
				style="table-layout:fixed; height: 350px" view="buttonsOnBottom"
				locale="${localeString}"
				state="it.dpe.igeriv.web.actions.PubblicazioniAction"
				styleClass="extremeTableFields" form="ContoDepositoForm"
				...
				<dpe:row highlightRow="true" style="height:30px">
					...
					<ec:column property="titolo" width="20%" title="igeriv.titolo"
						filterable="false" />
					<dpe:column property="quantitaContoDeposito" calc="total"
						calcTitle="column.calc.total" totalCellStyle="text-align:center"
						width="7%" title="igeriv.fornito.conto.deposito"
						filterable="false" style="text-align:center"
						headerStyle="text-align:center" />
					<dpe:column property="quantitaReso" calc="total"
						totalCellStyle="text-align:center" width="7%" title="igeriv.reso"
						filterable="false" style="text-align:center"
						headerStyle="text-align:center" />
					<dpe:column property="venduto" calc="total"
						totalCellStyle="text-align:center" width="7%"
						title="igeriv.venduto.conto.deposito" filterable="false"
						style="text-align:center" headerStyle="text-align:center" />
					<dpe:column property="prezzoCopertina" width="8%"
						title="igeriv.prezzo.copertina" filterable="false" cell="currency"
						format="###,###,##0.0000" style="text-align:right"
						headerStyle="text-align:right" />
					<dpe:column property="prezzoEdicola" width="8%"
						title="igeriv.prezzo.netto" filterable="false" cell="currency"
						format="###,###,##0.0000" style="text-align:right"
						headerStyle="text-align:right" />
					<dpe:column property="importo" calc="total"
						totalCellStyle="text-align:right" totalFormat="###,###,##0.00"
						width="7%" title="igeriv.importo" filterable="false"
						cell="currency" format="###,###,##0.0000" style="text-align:right"
						headerStyle="text-align:right" />
					<dpe:column property="importoL" calc="total"
						totalCellStyle="text-align:right" totalFormat="###,###,##0.00"
						width="7%" title="igeriv.importo.lordo" filterable="false"
					...
					<ec:column property="immagine" title="igeriv.img"
						...
						cell="viewImageCell" >
<%-- 						<a href="/immagini/${pageScope.listContoDeposito.immagine}" --%>
