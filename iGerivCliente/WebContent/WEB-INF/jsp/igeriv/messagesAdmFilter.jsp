...
<s:form id="filterForm" action="msgDpe_showMessages.action" method="POST" theme="simple" onsubmit="return (ray.ajax())" validate="false">	
	<div style="width:100%; text-align:center">
		...
		<fieldset class="filterBolla" style="width:700px; height:132px;"><legend style="font-size:100%"><s:property value="filterTitle" /></legend>
			...
			<div class="required">
				<div style="float:left; width:200px;"><s:text name="igeriv.attivi" /></div>
				<div style="float:left; width:400px; text-align:left">
					<s:checkbox name="abilitati" id="abilitati" cssClass="tableFields" value="true"/>
				</div>				
			</div>	
			<div class="required">		
				<div style="float:left; width:620px; margin-top:10px">
					...
					&nbsp;&nbsp;
					<input type="button" id="butVisualizza" value="<s:text name='igeriv.visualizza.messaggi.attivi'/>" align="center" cssStyle="align:center; width:150px"/>
				</div>
			</div>
		</fieldset>			
	</div> 
