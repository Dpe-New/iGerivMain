	...
	<s:form id="PrenotazioneClienteForm"
		...
		<div id="mainDiv" style="width: 100%">
			<dpe:table tableId="PrenotazioneCliente_table" items="ordini"
				...
				<ec:exportPdf fileName="prenotazioni_clienti.pdf"
				...
				<ec:row>
					...
					<dpe:column property="numeroCopertina" width="5%"
						...
						filterable="false" sortable="false" />
					<dpe:column property="prezzoCopertina" cell="currency" width="7%"
					...
					<dpe:column property="quantitaEvasa" validateIsNumeric="true"
						...
						styleClass="extremeTableFieldsLarger" filterable="false"
						sortable="false" exportStyle="text-align:center" />
					<dpe:column property="statoEvasioneDesc" maxlength="3" size="4"
						width="7%" title="igeriv.richiesta.rifornimenti.stato.evasione"
						styleClass="extremeTableFieldsLarger" filterable="false"
			...
			<div class="tableFields" id="prenotazioneDiv"
				...
				<div style="float: left;">
					...
					&nbsp;&nbsp;&nbsp;
					<s:textfield
						name="richiestaFissaClienteEdicolaVo.quantitaRichiesta"
						id="richiestaFissaClienteEdicolaVo.quantitaRichiesta"
						cssClass="extremeTableFields" cssStyle="width:50px;" />
				</div>
				<div style="float: left;">
					<s:text name="igeriv.numero.volte" />
					&nbsp;&nbsp;&nbsp;
					<s:select name="richiestaFissaClienteEdicolaVo.numeroVolte"
						id="richiestaFissaClienteEdicolaVo.numeroVolte"
				...
				<div style="float: left;">
					...
					<s:hidden
						name="richiestaFissaClienteEdicolaVo.pk.codicePubblicazione" />
				</div>
			</div>
			<div style="width: 450px; margin-top: 50px; margin-left: 380px;">
				<div
					...
					<input type="button" value="<s:text name='igeriv.memorizza'/>"
						...
						onclick="javascript: setTimeout(function() {return (validateFields('PrenotazioneClienteForm') && enableField() && setFormAction('PrenotazioneClienteForm','bollaRivendita_savePrenotazioniClienteEdicola.action', '', 'messageDiv'));},10);" />
				</div>
			</div>
		</div>
	</s:form>
