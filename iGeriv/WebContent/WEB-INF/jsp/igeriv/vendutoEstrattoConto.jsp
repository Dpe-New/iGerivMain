...
<s:if
	test="%{#request.listVendutoEstrattoConto != null && !#request.listVendutoEstrattoConto.isEmpty()}">
	<s:set name="ap" value="#context['struts.actionMapping'].namespace" />
	<s:if test='#context["struts.actionMapping"].namespace == "/"'>
		<s:set name="ap" value="" />
	</s:if>
	<s:form id="VendutoEstrattoConto" action="venduto_showVenduto.action"
		method="POST" theme="simple" validate="false"
		onsubmit="return (ray.ajax())">
		<div style="width: 100%">
			<s:if
				test="authUser.suddivisioneQuotidianiPeriodiciReportVenduto eq false">
				<dpe:table tableId="EstrattoContoTab"
					items="listVendutoEstrattoConto" var="listVendutoEstrattoConto"
					action="${pageContext.request.contextPath}${ap}/venduto_showVenduto.action"
					imagePath="/app_img/table/*.gif" title="${tableTitle}"
					rowsDisplayed="1000" view="buttonsOnTopAndBottom"
					...
					styleClass="extremeTableFields" form="VendutoEstrattoConto"
					theme="eXtremeTable bollaScrollDivTall" showPagination="false"
					id="EstrattoContoScrollDiv" toolbarClass="eXtremeTable"
					footerStyle="height:30px;" filterable="false" showTitle="false">
					<dpe:exportPdf
					...
					<ec:row style="height:25px">
						<dpe:column property="dataEstrattoConto" cell="date"
							dateFormat="dd/MM/yyyy" width="24%"
							title="igeriv.data.tipo.estratto.conto" filterable="false"
							style="text-align:center" headerStyle="text-align:center" />
						<dpe:column property="fornitoPeriodici" width="25%"
							cell="currency" hasCurrencySign="true" calc="total"
							calcTitle="column.calc.total" totalCellStyle="text-align:right"
							title="igeriv.fornito" filterable="false"
							style="text-align:right" headerStyle="text-align:right" />
						<dpe:column property="resoPeriodici" width="25%" cell="currency"
							hasCurrencySign="true" calc="total"
							totalCellStyle="text-align:right" title="igeriv.reso"
							filterable="false" style="text-align:right"
							headerStyle="text-align:right" />
						<dpe:column property="venduto" width="25%" cell="currency"
							hasCurrencySign="true" calc="total"
							totalCellStyle="text-align:right" title="igeriv.venduto"
							filterable="false" style="text-align:right"
							headerStyle="text-align:right" />
					</ec:row>
				</dpe:table>
			...
			<s:else>
				<dpe:table tableId="EstrattoContoTab"
					...
					<ec:row style="height:25px">
						<dpe:column property="dataEstrattoConto" cell="date"
							dateFormat="dd/MM/yyyy" width="12%"
							title="igeriv.data.tipo.estratto.conto" filterable="false"
							style="text-align:center" headerStyle="text-align:center" />
						<dpe:column property="fornitoQuotidiani" width="12%"
							cell="currency" hasCurrencySign="true" calc="total"
							calcTitle="column.calc.total" totalCellStyle="text-align:right"
							title="igeriv.fornito.quotidiani" filterable="false"
							style="text-align:right" headerStyle="text-align:right" />
						<dpe:column property="resoQuotidiani" width="12%" cell="currency"
							hasCurrencySign="true" calc="total"
							totalCellStyle="text-align:right" title="igeriv.reso.quotidiani"
							filterable="false" style="text-align:right"
							headerStyle="text-align:right" />
						<dpe:column property="vendutoQuotidiani" width="12%"
							cell="currency" hasCurrencySign="true" calc="total"
							totalCellStyle="text-align:right"
							title="igeriv.venduto.quotidiani" filterable="false"
							style="text-align:right" headerStyle="text-align:right" />
						<dpe:column property="fornitoPeriodici" width="12%"
							cell="currency" hasCurrencySign="true" calc="total"
							totalCellStyle="text-align:right"
							title="igeriv.fornito.periodici" filterable="false"
							style="text-align:right" headerStyle="text-align:right" />
						<dpe:column property="resoPeriodici" width="12%" cell="currency"
							hasCurrencySign="true" calc="total"
							totalCellStyle="text-align:right" title="igeriv.reso.periodici"
							filterable="false" style="text-align:right"
							headerStyle="text-align:right" />
						<dpe:column property="vendutoPeriodici" width="12%"
							cell="currency" hasCurrencySign="true" calc="total"
							totalCellStyle="text-align:right"
							title="igeriv.venduto.periodici" filterable="false"
							style="text-align:right" headerStyle="text-align:right" />
						<dpe:column property="venduto" width="12%" cell="currency"
							hasCurrencySign="true" calc="total"
							totalCellStyle="text-align:right" title="igeriv.venduto"
							filterable="false" style="text-align:right"
							headerStyle="text-align:right" />
