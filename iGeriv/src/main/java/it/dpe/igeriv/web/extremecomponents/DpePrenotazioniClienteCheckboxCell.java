	...
	public String getHtmlDisplay(TableModel model, Column column) {
		...
		try {
			...
			if (allowDelete) {
				...
				String idtn = BeanUtils.getProperty(bean, "idtn");
				...
				if (selectedSpuntaIds != null
					...
					columnBuilder.getHtmlBuilder().input("checkbox").name(chkName).id(DPEWebContants.DPE_CHECKBOX_NAME + spuntaId).value(spuntaId).styleClass(DPEWebContants.STYLE_CLASS_TEXT).append(" idtn=\"" + idtn + "\"");
