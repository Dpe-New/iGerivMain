...
<div style="width:100%">	
	<dpe:table
		...
		<dpe:row style="height:30px">					
			<dpe:column property="coddl" width="5%" title="username.dl" filterable="false" style="text-align:center" headerStyle="text-align:center"/>  
			<dpe:column property="nomeDl" width="20%" title="dpe.nome.dl" filterable="false" style="text-align:left" headerStyle="text-align:left"/>
			...
			<dpe:column property="codEdicolaDl" width="5%" title="dpe.login.dl.fieg.code.short" filterable="false" style="text-align:center" headerStyle="text-align:center"/>              
			<dpe:column property="nomeEdicola" width="20%" title="dpe.nome.edicola" filterable="false" style="text-align:left" headerStyle="text-align:left" />
			...
			<dpe:column property="roleName" width="10%" title="igeriv.tipo.profilo" filterable="false" style="text-align:center" headerStyle="text-align:center"/>
			<dpe:column property="importo" width="10%" title="igeriv.importo" calc="total" calcTitle="column.calc.total" hasCurrencySign="true" totalFormat="###.###.##0,00" totalCellStyle="text-align:right" cell="currency" format="###.###.##0,00" filterable="false" style="text-align:right" headerStyle="text-align:right"/> 
		</dpe:row>
	</dpe:table>
</div>		
</s:form>
