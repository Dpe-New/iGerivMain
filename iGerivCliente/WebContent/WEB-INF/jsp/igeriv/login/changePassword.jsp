...
<s:form name="ChangePwdForm" id="ChangePwdForm" action="/changePwd_changeCliente.action" theme="igeriv" validate="true"
	onsubmit="return (ray.ajax())">	
	<s:hidden id="codEdicola" name="codEdicola"></s:hidden>	
	<s:hidden id="id" name="id"></s:hidden>	
	<fieldset><legend><s:text name="gp.gestione.clienti.edicola"/> - <s:text name="gp.cambio.password" /></legend>	
