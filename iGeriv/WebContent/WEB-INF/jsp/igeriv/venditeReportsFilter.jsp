...
<s:form id="VenditeReportForm" action="reportVendite_showReport"
				...
				<div style="width: 650px" id="filtroVendita1">
					<div class="required">
						<div style="float: left; width: 307px; margin-top: 10px">
							<s:text name="igeriv.data.vendita.det" />
						</div>
						<div
							style="float: left; width: 300px; text-align: left; margin-top: 10px">
							<s:textfield name="strDataVendita" id="strDataVendita"
								cssClass="extremeTableFields" cssStyle="width:80px;"
								disabled="false" />
							&nbsp;&nbsp;
							<s:select name="tipoProdotto" id="tipoProdotto" listKey="keyInt"
								listValue="value" list="tipiProdotto"
				...
				<div style="width: 650px" id="filtroVendita2">
					<div class="required">
						<div style="float: left; width: 280px; margin-top: 10px">
							<s:text name="igeriv.intervallo.data.vendita" />
						</div>
						<div
					...
					<div class="required">
						<div style="float: left; width: 280px; margin-top: 10px;">
							<s:text name="igeriv.raggruppamento" />
						</div>
						<div style="float: left; width: 350px; margin-top: 10px">
							<s:iterator value="%{#session['listRaggruppamento']}"
								status="status">
								<input type="radio" name="raggruppamento"
									value='<s:text name="key"/>'
									<s:if test="key eq raggruppamento">checked</s:if>>&nbsp;&nbsp;<s:text
									name="value" />&nbsp;												
							</s:iterator>
						</div>
					</div>
					<s:if test="authUser.admin == true">
						<div class="required">
							<div style="float: left; width: 307px; margin-top: 10px;">
								<s:text name="dpe.utente" />
							</div>
							<div style="float: left; width: 300px; margin-top: 10px">
								<s:select name="codUtente" id="codUtente" listKey="key"
									listValue="value" list="utenti" cssClass="extremeTableFields"
