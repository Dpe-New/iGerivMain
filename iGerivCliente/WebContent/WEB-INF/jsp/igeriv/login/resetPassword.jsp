...
<s:form name="security_form" id="security_form"
	action="/loginResetPwd_resetPwdCliente.action" theme="simple"
	onsubmit="return (validateFieldsReset() && ray.ajax());">	
	<fieldset><legend><s:text name="gp.gestione.clienti.edicola"/> - <s:text name="password.dimenticata" /></legend>
		...
		<div class="required" style="float:left">
			<div style="float:left; width:160px;">
				<label for="emailEdicola"><s:text name="msg.email.lettore"/><em>*</em></label> 
			</div>
			<div style="float:left; width:160px;">
