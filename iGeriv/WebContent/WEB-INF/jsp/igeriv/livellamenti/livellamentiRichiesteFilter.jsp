...
<s:form id="RichiesteReteEdicolaReportFilterForm"
	action="livellamenti_showRichieste.action" method="POST" theme="simple"
		...
		<div style="width: 100%; text-align: left">
			...
			<fieldset class="filterBolla"
				...
				<legend style="font-size: 100%">
					<s:text name="igeriv.richieste.rifornimento.rete.edicola" />
				</legend>
					...
					<div style="width: 650px" id="filtroVendita1">
						<div class="required">
							<div style="float: left; width: 307px; margin-top: 10px">
								<s:text name="igeriv.richiesta.rifornimenti.stato.richiesta" />
							</div>
							<div
								style="float: left; width: 300px; text-align: left; margin-top: 10px">
								<s:select name="stato" id="stato" listKey="keyInt"
									listValue="value"
									list="#application.listStatiRichiestaReteEdicola"
