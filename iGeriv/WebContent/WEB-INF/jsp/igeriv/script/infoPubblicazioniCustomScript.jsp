...
<script>
	$(document).ready(function() {
		...
		// Modifica 23/11/2017 spostare maialino del conto deposito nel campo note per visualizzare sempre barcode
		//$("#InfoPubblicazioniTab_table tbody tr td:nth-child(8)").each(function() {	
		$("#InfoPubblicazioniTab_table tbody tr td:nth-child(9)").each(function() {	
