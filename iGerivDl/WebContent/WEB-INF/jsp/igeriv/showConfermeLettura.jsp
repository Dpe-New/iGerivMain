...
<div id="mainDocDiv">
	...
	<s:if test="%{#request.conferme}">	
		<s:form id="ShowConfermeLetturaForm" action="messages_showConfermeLettura.action" method="POST" theme="simple" validate="false" onsubmit="return (ray.ajax())">			
			<div id="mainDiv1" style="width:680px">		
					<dpe:table
						...
						<ec:row style="height:20px">			
							...
							<ec:column property="messaggioLettoDesc" width="20%" title="igeriv.messaggio.letto" styleClass="extremeTableFieldsLarger" filterable="false" style="text-align:center" sortable="false"/>
						</ec:row>
					</dpe:table> 					
			</div>
		</s:form>	
