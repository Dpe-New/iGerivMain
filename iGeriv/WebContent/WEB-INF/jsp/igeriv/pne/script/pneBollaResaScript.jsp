...
// 		});	
		$("#butNuovo").click(function() {
			...
			var url = "${pageContext.request.contextPath}/pneResa_editBolla.action?codFornitore=" + $("#codFornitore").val();
			openDiv("popup_name", 900, 470, url);
			return false;
		});
		 
		$("#BolleProdottiVariTab_table tbody tr").click(function() {
			var url = "${pageContext.request.contextPath}/pneResa_editBolla.action?idDocumento=" + $(this).find("td").first().text().trim();
			openDiv("popup_name", 900, 470, url);
			return false;
		});
		$("#codFornitore").focus();
