...
<script>
	...
	var msgNessunaPubb = "<s:text name='label.barcode_input_module_listener.Pubblication_Not_Found'/>";
	...
	$(document).ready(function() {
		...
		rowsCallback = function(bean) {
			if (bean != null) {
				if (bean.type == 'EXCEPTION') {							
					...
					populateTablePubblicazioni(bean.result);
					unBlockUI();
					$('#inputText').val('');
		...
		writeOutputLine = function(bean) {
			var html = '<table cellspacing="0" cellpadding="0" border="0" width="100%" style="table-layout: fixed;" class="extremeTableFieldsVeryLarge" id="InventarioTab_table"><thead><tr>'
				+ '<td width="20%" class="tableHeader" style="text-align:left">' + msgTitolo + '</td>'
				+ '<td width="20%" class="tableHeader" style="text-align:left">' + msgSottotitolo + '</td>'
				+ '<td width="8%" class="tableHeader" style="text-align:center">' + msgNumero + '</td>'
				+ '<td width="10%" class="tableHeader" style="text-align:right">' + msgPrezzoAcquisto + '</td>'
				+ '<td width="10%" class="tableHeader" style="text-align:right">' + msgPrezzoLordo + '</td>'
				+ '<td width="12%" class="tableHeader" style="text-align:center">' + msgDataUscita + '</td>'
				+ '<td width="10%" class="tableHeader" style="text-align:center">' + msgQta + '</td>'
			...
			html += '<tbody><tr><td width="20%">' + bean.titolo + '</td>'
				+ '<td width="20%">' + bean.sottoTitolo + '</td>'
