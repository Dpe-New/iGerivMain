...
public class DpeToolbarBuilder extends ToolbarBuilder {
	...
	public void rowsDisplayedDroplist() {
		int rowsDisplayed = getTableModel().getTableHandler().getTable().getAttribute("minRowsDisplayed") != null ? new Integer(getTableModel().getTableHandler().getTable().getAttributeAsString("minRowsDisplayed")) : new Integer(getTableModel().getPreferences().getPreference(DpePreferencesConstants.TABLE_MIN_ROWS_DISPLAYED)).intValue();
