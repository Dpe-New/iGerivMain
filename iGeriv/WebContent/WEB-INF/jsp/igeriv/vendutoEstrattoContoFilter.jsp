...
<s:form id="VendutoEstrattoContoFilterForm"
	action="venduto_showVenduto.action" onsubmit="return (ray.ajax())"
		...
		<fieldset class="filterBolla" style="width: 450px; text-align: center">
			...
			<div class="required"
				...
				<div style="float: left; width: 250px;">
					...
					&nbsp;&nbsp;
					<s:textfield name="dataDaStr" id="dataDaStr" cssStyle="width:78px;"
						disabled="false" />
					&nbsp;&nbsp;
					<s:text name="igeriv.a" />
					&nbsp;&nbsp;
					<s:textfield name="dataAStr" id="dataAStr" cssStyle="width:78px;"
						disabled="false" />
				</div>
			</div>
