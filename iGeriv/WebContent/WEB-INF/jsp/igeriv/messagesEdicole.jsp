...
<s:if
	...
	<s:form id="MessaggiForm" action="messages_showMessagesEdicole.action"
			...
			<dpe:table tableId="MessaggiTab" items="messaggi" var="messaggi"
				...
				<dpe:row highlightRow="true" interceptor="marker"
					...
					<ec:column property="dtMessaggio" cell="date"
						format="dd/MM/yyyy HH:mm:ss" width="15%"
						title="igeriv.data.messaggio" filterable="false" />
					<ec:column property="messaggioShort" width="45%"
						title="dpe.contact.form.message" filterable="false" />
					<ec:column property="tipoMessaggioDesc" width="8%"
						title="igeriv.tipo.messaggio" filterable="false" />
					<ec:column property="messaggioLettoDesc" width="8%"
