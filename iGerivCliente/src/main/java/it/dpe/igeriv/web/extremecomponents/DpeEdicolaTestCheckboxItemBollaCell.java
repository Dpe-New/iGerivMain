 ...
 *
 */
public class DpeEdicolaTestCheckboxItemBollaCell implements Cell {
	...
	public String getHtmlDisplay(TableModel model, Column column) {
		...
		try {
			...
			HtmlBuilder check = columnBuilder.getHtmlBuilder().input("checkbox").name(chkName).id(chkName + spuntaId);
